...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1658</h1>", unsafe_allow_html=True)  # XXXX = 4 digit npm terakhir
...
if uploaded_file is not None:
    ...
    model_directory = r'"D:\Semester 5\PMDPM\Pertemuan 3\Tugas3_A_11658"'
